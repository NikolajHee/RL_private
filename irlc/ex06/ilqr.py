...
described in (Her21, Algorithm 25).
...
def get_derivatives(model, x_bar, u_bar):
    ...
    Meanwhile the terms c, c_x, ... has the meaning described in (Her21, Subequation 15.8), i.e. the derivatives of the c (cost) terms.
