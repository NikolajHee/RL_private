...
def LQR(A, B, d=None, Q=None, R=None, H=None, q=None, r=None, qc=None, QN=None, qN=None, qcN=None, mu=0):
    """
    Implement LQR as defined in (Her23, Algorithm 22). All terms retain their meaning/order of computation from the code; please be careful with the linear algebra!
