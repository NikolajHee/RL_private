...
class DP2SP(SearchProblem):
    ...
    def available_transitions(self, state):
        """ Implement the dp-to-search-problem conversion described in (Her21, Theorem 7.2.2). Keep in mind the time index is
...
class GraphSP(SearchProblem): 
    """ Implement the small graph graph problem in (Her21, Subsection 5.1.1) """
    G = G222
