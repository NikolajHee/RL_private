...
if __name__ == "__main__":
    ...
    env = CarEnvironment(noise_scale=0,Tmax=30, max_laps=4, render_mode='human')
    agent = PIDCarAgent(env, v_target=5, use_both_x5_x3=True) # I recommend lowering v_target to make the problem simpler.
