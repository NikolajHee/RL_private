...
class ContiniousTimeSymbolicModel: 
    ...
    In this description both x and u are vectors. In addition to this, the model al
    ...
    def simulate(self, x0, u_fun, t0, tF, N_steps=1000, method='rk4'):
        ...
        for k in range(N_steps):
            ...
            if method == 'rk4':
                ...
                The algorithm you implement is: (Her21, Algorithm 18). Remember to use breakpoints and the debugger console.
                """
