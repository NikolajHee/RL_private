...
def partA_simulation():
    ...
    """
    Part 1: Obtain simulation paths using Euler and RK4 integration. See (Her21, Section 11.1)
    """
    N = 500
...
def partB_discretization():
    ...
    See (Her21, Subsection 11.2.6), and keep in mind that the following is the level of precision that your 
