...
if __name__ == "__main__":
    ...
    env1 = PacmanEnvironment(layout_str=layout1) # Create environment 
    ...
    # To show what pacman actually does in the two cases, pass render_mode='human' to the pacman environment.
    t0 = time.time()
