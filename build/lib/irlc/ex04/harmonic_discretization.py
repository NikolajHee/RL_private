...
def partA_simulation():
    ...
    """
    Part 1: Obtain simulation paths using Euler and RK4 integration. See (Her23, Section 11.1)
    """
    N = 500
...
def partB_discretization():
    ...
    See (Her23, Subsection 11.2.6), and keep in mind that the following is the level of precision that your 
    ...
    # Plotting:
    ts, x_true = solve_harmonic(dmodel.continuous_model, d=x0[0], tF=100)
    plt.plot(ts, x_true, 'k-', label="True solution")
